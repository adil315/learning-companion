    ...
    return (
        <div className="min-h-screen bg-[#0a0015] text-white">
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6">
                ...
                <div className="mb-6 md:mb-8 p-5 md:p-8 rounded-2xl bg-gradient-to-r from-purple-700 to-pink-700 relative overflow-hidden">
                    {/* Decorative elements */}
                    ...
                    <div className="absolute bottom-0 left-1/2 w-24 md:w-48 h-24 md:h-48 bg-pink-500/20 rounded-full blur-2xl"></div>
